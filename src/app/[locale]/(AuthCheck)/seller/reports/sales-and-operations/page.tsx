import { SellerReportsCountrySelector } from "@/components/seller-components/seller-reports/SellerReportsCountrySelector";
...
export default function SellerSalesAndOperationsPage() {
  const tabs = [
    { label: "Satış", href: "/urun-bazli-satis" },
    { label: "Sipariş Dağılım", href: "/siparis-dagilim", isNew: true },
