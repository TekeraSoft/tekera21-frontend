      ...
      <div className="pb-80  sm:pb-40 sm:pt-24 lg:pb-48 lg:pt-50">
        <div className="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
          <div className="sm:max-w-lg">
            <h1 className="text-2xl  md:text-4xl font-bold tracking-tight text-gray-900 lg:text-6xl">
              Yeni sezon t-shirtler artık burada
            </h1>
            <p className="mt-4 md:text-xl text-gray-500">
              Benzersiz tasarımlar ve yüksek kaliteli kumaşlarla üretilen
              t-shirtlerimizle tarzınızı yansıtın. Tekera21 ile stilinizi bir
              adım öteye taşıyın.
            </p>
          </div>
          <div>
            <div className="mt-10">
              ...
              <Button size={"lg"} variant={"primary"}>
                <Link href="/all-products">Koleksiyonu Keşfet</Link>
              </Button>
            </div>
          </div>
        </div>
